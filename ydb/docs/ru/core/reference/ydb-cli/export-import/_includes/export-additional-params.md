...
- `--encryption-algorithm ALGORITHM`: Шифровать выгружаемые данные используя указанный алгоритм. Поддерживаемые значения: `AES-128-GCM`, `AES-256-GCM`, `ChaCha20-Poly1305`. Требует включения флага [`enable_encrypted_export`](../../../configuration/feature_flags.md) в конфигурации кластера.
